  ...
  <div class="resource-wrapper">
    <div class="resource">
      <div class="d-flex justify-content-start align-items-center">
        <!-- Imagen Vida -->
        <div class="resource-icon resource-life me-2" />
        <!-- Nombre -->
        <div class="ml-3 text-uppercase name-text me-2">
    ...
    <div class="resource">
      <div class="d-flex justify-content-start align-items-center">
        <!-- Imagen Recurso -->
        <div class="resource-icon me-2" :class="classResourceName" />
        <!-- Nombre -->
        <div
          class="ml-3 text-uppercase name-text me-2"
        ...
        <div class="ml-3">
          ...
          <span class="text-monospace">
            ...
            <template v-if="hasSecondaryResource">
              ...
              <span>
                {{ formatNumber(resources.resources.secondaryResource.val) }}
              </span>
            </template>
          </span>
        </div>
